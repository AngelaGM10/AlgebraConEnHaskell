...
y seguidamente daremos las noción de un anillo que es especialmente relevante para el álgebra constructiva. Lo veremos implementado en el módulo \texttt{TAHStronlyDiscrete}\entrada{TAHStronglyDiscrete}
