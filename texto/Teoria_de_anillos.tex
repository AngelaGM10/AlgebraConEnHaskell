...
\section{Anillos}
Comenzamos dando las primeras definiciones y propiedades básicas que tiene un anillo para posteriormente introducir los anillos conmutativos en el módulo \texttt{TAH}\entrada{TAH}
