...
\begin{defi}
Un anillo es fuertemente discreto si podemos decidir que un mienbro de un ideal es decidible, es decir, podemos decidir si un sistema $a_1x_1+..+a_nx_n = b$ tiene solución o no.
\end{defi}
