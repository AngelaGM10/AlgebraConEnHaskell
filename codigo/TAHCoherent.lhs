...
\begin{defi}
Un anillo R es coherente si todo ideal generado finitamente es finito
presentado. Esto significa que dado una matriz $M \in\, R^{1\times n}$ existe una matriz $L \in\, R^{n\times m}$ para $m \in\, \mathbb{N}$ tal que $ML=0$ y\\
\begin{center}
...
de ecuaciones en un anillo coherente. En otras palabras, el módulo de lasolución para $MX = 0$ esta generado finitamente.
